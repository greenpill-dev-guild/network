...
function applyTemplate(templateFile, destinationDir, replacements) {
...
function commandScaffold(args) {
  ...
  if (!slug) {
    fail("Usage: node scripts/plan-hub.mjs scaffold <feature-slug> [--title \"Feature Title\"] [--stage backlog]");
  }
