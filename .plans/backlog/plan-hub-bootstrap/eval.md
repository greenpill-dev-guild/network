...
- `.plans/` and `packages/` stay clearly separated in purpose
...
This hub has done its job when the planning surface is present, validated, and easy to reuse for later work without pulling runtime/package truth into planning notes or recreating root docs.
