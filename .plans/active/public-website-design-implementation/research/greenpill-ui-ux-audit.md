...
- The V2 decision context now treats the workspace as `app.greenpill.network` and keeps active architecture planning in `.plans`.

This document is a design audit, information architecture proposal, and migration UX plan for the Greenpill Network website refresh. It is grounded in the current repo (`release/2.0`), the existing design language, and the research pack in `.plans/active/public-website-design-implementation/research/`.
...
| `.plans/active/public-website-design-implementation/research/greenpill-current-state.md` | Network research: what Greenpill actually is now |
| `.plans/active/public-website-design-implementation/research/greenpill-website-direction.md` | IA and audience strategy |
| `.plans/backlog/knowledge-commons-graph-explorer/research/greenpill-knowledge-map.md` | Network relationship model |
| `.plans/active/public-website-design-implementation/research/greenpill-charmverse-transition.md` | Charmverse migration plan and stack recommendations |
