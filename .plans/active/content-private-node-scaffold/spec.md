...
- Public collections now include richer book fields, canonical resources, themes, reusable public people/stewards, and theme/steward references across chapters, guilds, projects, and stories.
...
- Public content model: keep Keystatic canonical for books, resources, translations, chapters, guilds, projects, stories, themes, singletons, and public people/stewards.
...
- CMS/admin decision: Directus has a provisional go for a separate hands-on moderation pilot; compare remaining tools before committing to an admin layer.
...
- Directus is the first CMS/admin candidate to evaluate, but the schema must remain CMS-agnostic and SQL migrations stay authoritative.

## Open Questions

- Does a hands-on Directus pilot enforce the steward/trusted-steward split cleanly enough to avoid a custom moderation app?
